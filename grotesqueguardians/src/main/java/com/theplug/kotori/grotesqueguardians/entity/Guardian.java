...
public class Guardian
{
    ...
    public enum Variant
    {
        ...
        DUSK_DESPAWN(NpcID.DUSK_7889, false, Set.of(), Set.of(), DUSK_ATTACK_TICK_SPEED, AttackStyle.UNKNOWN),
        ...
        DAWN_DESPAWN(NpcID.DAWN_7885, false, Set.of(), Set.of(), DAWN_ATTACK_TICK_SPEED, AttackStyle.UNKNOWN),
