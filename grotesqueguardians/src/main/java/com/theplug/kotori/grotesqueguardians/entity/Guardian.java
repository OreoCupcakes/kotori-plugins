...
public class Guardian
{
    ...
    public enum Variant
    {
        DUSK_PHASE_1(NpcID.GARGBOSS_DUSK_PHASE1_DEFENSIVE, false, Set.of(DUSK_PHASE_1_ANIMATION_MELEE), Set.of(), DUSK_ATTACK_TICK_SPEED, AttackStyle.MELEE),
        DUSK_PHASE_2(NpcID.GARGBOSS_DUSK_PHASE2_ATTACKING, false, Set.of(DUSK_PHASE_2_ANIMATION_MELEE_7786, DUSK_PHASE_2_ANIMATION_MELEE_7788, DUSK_PHASE_2_ECLIPSE_EXPLOSION), Set.of(), DUSK_ATTACK_TICK_SPEED, AttackStyle.MELEE),
        DUSK_PHASE_3(NpcID.GARGBOSS_DUSK_PHASE3_DEFENSIVE, false, Set.of(DUSK_PHASE_3_ANIMATION_MELEE_7785, DUSK_PHASE_3_ANIMATION_MELEE_7787), Set.of(), DUSK_ATTACK_TICK_SPEED, AttackStyle.MELEE),
        DUSK_PHASE_4(NpcID.GARGBOSS_DUSK_PHASE4, false, Set.of(DUSK_PHASE_4_ANIMATION_MELEE, DUSK_PHASE_4_ANIMATION_RANGE), Set.of(DAWN_PROJECTILE_RANGED_ATTACK), DUSK_ATTACK_TICK_SPEED, AttackStyle.RANGE),
        DUSK_DESPAWN(NpcID.GARGBOSS_DUSK_DEATH, false, Set.of(), Set.of(), DUSK_ATTACK_TICK_SPEED, AttackStyle.UNKNOWN),
        DAWN_PHASE_1(NpcID.GARGBOSS_DAWN_PHASE1, false, Set.of(DAWN_ANIMATION_MELEE_ATTACK, DAWN_ANIMATION_RANGED_ATTACK, DAWN_ANIMATION_STONE_ORB), Set.of(DAWN_PROJECTILE_RANGED_ATTACK, DAWN_PROJECTILE_STONE_ORB), DAWN_ATTACK_TICK_SPEED, AttackStyle.RANGE),
        DAWN_PHASE_3(NpcID.GARGBOSS_DAWN_PHASE3, false, Set.of(DAWN_ANIMATION_MELEE_ATTACK, DAWN_ANIMATION_RANGED_ATTACK, DAWN_ANIMATION_STONE_ORB), Set.of(DAWN_PROJECTILE_RANGED_ATTACK, DAWN_PROJECTILE_STONE_ORB), DAWN_ATTACK_TICK_SPEED, AttackStyle.RANGE),
        DAWN_DESPAWN(NpcID.GARGBOSS_DAWN_DEATH, false, Set.of(), Set.of(), DAWN_ATTACK_TICK_SPEED, AttackStyle.UNKNOWN),
        ECHO_DUSK(NpcID.GARGBOSS_DUSK_PHASE4, true, Set.of(DUSK_PHASE_4_ANIMATION_RANGE), Set.of(DAWN_PROJECTILE_RANGED_ATTACK), DUSK_ATTACK_TICK_SPEED, AttackStyle.RANGE),
        ECHO_DAWN(NpcID.GARGBOSS_DAWN_PHASE1, true, Set.of(DAWN_ANIMATION_STONE_ORB), Set.of(DAWN_PROJECTILE_STONE_ORB), ECHO_DAWN_ATTACK_TICK_SPEED, AttackStyle.RANGE),
        DEFINITELY_NOT_DUSK(NpcID.GARGBOSS_DUSK_PHASE2_ATTACKING, true, Set.of(DUSK_PHASE_2_ECLIPSE_EXPLOSION), Set.of(), DEFINITELY_NOT_DUSK_ATTACK_TICK_SPEED, AttackStyle.UNKNOWN);
