...
public class MenusLibrary
{
    ...
    public void insertMenuEntry(int index, MenuEntry entry, int itemid)
    {
        setMenuOption(index, entry.getOption());
        setMenuTarget(index, entry.getTarget());
        setMenuOpcode(index, entry.getType().getId());
        setMenuIdentifier(index, entry.getIdentifier());
        setMenuParam0(index, entry.getParam0());
        setMenuParam1(index, entry.getParam1());
        setMenuItemId(index, itemid);
    }
}
